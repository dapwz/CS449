...
SPlayerR1 = tk.Radiobutton(
    LeftFrame, text='S', value='Blue', variable=SPlayer, justify="left")
OPlayerR1 = tk.Radiobutton(
    LeftFrame, text='O', value='Red', variable=SPlayer, justify="left")
...
SPlayerR2 = tk.Radiobutton(
    RightFrame, text='S', value='Red', variable=SPlayer, justify="left")
OPlayerR2 = tk.Radiobutton(
    RightFrame, text='O', value='Blue', variable=SPlayer, justify="left")
...
winState = gameBoard.placeMove('Blue','S',4,5)
winState = gameBoard.makeMove('Red','O',5,5)
winState = gameBoard.makeMove('Blue','S',6,5)


gameBoard.printBoard()
print('Game Score( Red: ', gameBoard.getRedScore(),
      ', Blue: ', gameBoard.getBlueScore(), ' ) ', winState)
